...
with open('conn_file/conn_file_Exh3_Vibr1.txt', 'r', encoding='utf-8') as file:
...
# ********************************** делаю выгрузку данных за 12 час для нахождения среднего значения **********
    ...
    temp_str1 = 'select TagTime, TagValue  from Exh3_Vibr1 where TagTime <= ' + "'" + temp_x1_1 + "'" + ' and ' + 'TagTime >= ' + "'" + temp_x1_2 + "'"
