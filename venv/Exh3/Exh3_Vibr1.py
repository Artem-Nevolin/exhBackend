...
with open('conn_file_Exh3_Vibr1.txt', 'r', encoding='utf-8') as file:
...
if len(data_kafka) > 1:
    ...
    try:
        ...
        if (db_list[0][0] == data_kafka[0][0]):
            ...
            with open('conn_file_Exh3_Vibr1.txt', 'r', encoding='utf-8') as fr:
                lines = fr.readlines()
            ...
            #print(lines)
            with open('conn_file_Exh3_Vibr1.txt', 'w', encoding='utf-8') as fl:
                #print(88)
                fl.writelines(lines)
