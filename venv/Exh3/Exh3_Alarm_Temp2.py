...
with open('conn_file/conn_file_Exh3_Temp2.txt', 'r', encoding='utf-8') as file:
...
# ********************************** делаю выгрузку данных за текущий час для нахождения среднего значения **********
    temp_str2 = 'select TagTime, TagValue  from Exh3_Temp2 where TagTime <= ' + "'" + temp_x2_1 + "'" + ' and ' + 'TagTime >= ' + "'" + temp_x2_2 + "'"
...
# ********************************** делаю выгрузку данных за 12 час для нахождения среднего значения **********
    ...
    temp_str1 = 'select TagTime, TagValue  from Exh3_Temp2 where TagTime <= ' + "'" + temp_x1_1 + "'" + ' and ' + 'TagTime >= ' + "'" + temp_x1_2 + "'"
