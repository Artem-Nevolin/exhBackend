...
if len(data_kafka) > 1:
    ...
    try:
        ...
        sql = "INSERT INTO ExhHub (TagTime, TagValue) VALUES (?, ?)"
        #print(11)
        ...
        cur.execute("select TagTime, TagValue  from ExhHub where TagTime = (select MAX(TagTime) from ExhHub)")  # записываю в курсор максимальное значение времени из БД
