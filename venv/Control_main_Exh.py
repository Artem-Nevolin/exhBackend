...
def exh1_Alarm_Vibr7():
    ######################## Считываю данные из conn_file_Exh_ для опредения последнего записанного времени

    with open('Exh3/conn_file/conn_file_Exh1_Vibr7.txt', 'r', encoding='utf-8') as file:
    ...
    try:
        ...
        ####### определяю последнее записанное значение по максимальной дате ################################
        cur.execute(
            "select TagTime, Nag1_Vibr7  from Exh_All where TagTime = (select MAX(TagTime) from Exh_All)")  # записываю в курсор максимальное значение времени из БД
        ...
        temp_str2 = 'select TagTime, Nag1_Vibr7  from Exh1_All where TagTime <= ' + "'" + temp_x2_1 + "'" + ' and ' + 'TagTime >= ' + "'" + temp_x2_2 + "'"
        ...
        exh1_Alarm_Vibr7_temp_str1 = 'select TagTime, Nag1_Vibr7  from Exh1_All where TagTime <= ' + "'" + temp_x1_1 + "'" + ' and ' + 'TagTime >= ' + "'" + temp_x1_2 + "'"
        ...
        cur.execute(exh1_Alarm_Vibr7_temp_str1)  # записываю в курсор данные за последний час
        # print('333')
        # print(type(cur))
        for mnp1 in cur:
        ...
        if len(mean_point_1) > 0:
            ...
            for kl in mean_point_2:
                ...
                sum2 = sum2 + value2
                count_2 += 1
            exh1_Alarm_Vibr7_mean2 = round(sum2 / count_2, 2)  # округляю
            # print(sum2)
            # print(count_2)
            ...
            for kb in mean_point_1:
                ...
                sum1 = sum1 + value1
                count_1 += 1
            exh1_Alarm_Vibr7_mean1 = round(sum1 / count_1, 2)  # округляю
            # print(sum1)
            # print(count_1)
            #print('среднее значение за 12 час(M1)', exh3_Alarm_Vibr1_mean1)

            # *******************************************************************************************
            exh1_Alarm_Vibr7_mean = 7.09  # уставка, при достижении, которой необходимо узнать дату и время *************
            # *******************************************************************************************

            #print('exh3_Alarm_Vibr1_mean1', exh3_Alarm_Vibr1_mean1)
            #print('exh3_Alarm_Vibr1_mean2', exh3_Alarm_Vibr1_mean2)

            if exh1_Alarm_Vibr7_mean1 > exh1_Alarm_Vibr7_mean2:
                #print('снижение вибрации за рассматриваемый диапазон по вибрации т.2')
                exh1_Alarm_Vibr7_predictor = datetime.datetime.strptime(('9999-02-01 01:01:01').strip(),
                                                       '%Y-%m-%d %H:%M:%S')
                exh1_Alarm_Vibr7_str_time_to_alarm = '9999-09-09'
                #print('exh3_Alarm_Vibr1_predictor', exh3_Alarm_Vibr1_predictor)

            else:
                exh1_Alarm_Vibr7_predictor = ((exh1_Alarm_Vibr7_mean - exh1_Alarm_Vibr7_mean1) * (x2_1 - x1_1)) / (exh1_Alarm_Vibr7_mean2 - exh1_Alarm_Vibr7_mean1) + x1_1
                #print('exh3_Alarm_Vibr1_predictor', exh3_Alarm_Vibr1_predictor)

                # print('дата и время выхода из строя ротора', (str(predictor))[:19])

                exh1_Alarm_Vibr7_time_to_alarm = exh1_Alarm_Vibr7_predictor - x2_1
                exh1_Alarm_Vibr7_str_time_to_alarm = (str(exh1_Alarm_Vibr7_time_to_alarm))[:16]
        ...
        return exh1_Alarm_Vibr7_predictor, exh1_Alarm_Vibr7_str_time_to_alarm
...
def exh1_Alarm_Vibr8():
    ######################## Считываю данные из conn_file_Exh_ для опредения последнего записанного времени

    with open('Exh3/conn_file/conn_file_Exh1_Vibr8.txt', 'r', encoding='utf-8') as file:
    ...
    try:
        ...
        ####### определяю последнее записанное значение по максимальной дате ################################
        cur.execute(
            "select TagTime, Nag1_Vibr8  from Exh_All where TagTime = (select MAX(TagTime) from Exh_All)")  # записываю в курсор максимальное значение времени из БД
        ...
        # ********************************** делаю выгрузку данных за текущий час для нахождения среднего значения **********
        temp_str2 = 'select TagTime, Nag1_Vibr8  from Exh1_All where TagTime <= ' + "'" + temp_x2_1 + "'" + ' and ' + 'TagTime >= ' + "'" + temp_x2_2 + "'"
        # print('temp_str2', temp_str2)
        # print('x2_1', x2_1)
        # print('x2_2', x2_2)
        mean_point_2 = []  # создаю пустой список (первый час) для дальнейшей записи в него последнего времени и значения переменной
        ...
        exh1_Alarm_Vibr8_temp_str1 = 'select TagTime, Nag1_Vibr8  from Exh1_All where TagTime <= ' + "'" + temp_x1_1 + "'" + ' and ' + 'TagTime >= ' + "'" + temp_x1_2 + "'"
        # print('temp_str1', temp_str1)
        # print('x1_1', x1_1)
        # print('x1_2', x1_2)

        mean_point_1 = []  # создаю пустой список (12 час) для дальнейшей записи в него последнего времени и значения переменной
        cur.execute(exh1_Alarm_Vibr8_temp_str1)  # записываю в курсор данные за последний час
        # print('333')
        # print(type(cur))
        for mnp1 in cur:
            mean_point_1.append(mnp1)
        ...
        if len(mean_point_1) > 0:
            ...
            for kl in mean_point_2:
                ...
                sum2 = sum2 + value2
                count_2 += 1
            exh1_Alarm_Vibr8_mean2 = round(sum2 / count_2, 2)  # округляю
            # print(sum2)
            # print(count_2)
            # print('среднее значение за 1 час(M2)', mean2)
            ...
            for kb in mean_point_1:
                ...
                sum1 = sum1 + value1
                count_1 += 1
            exh1_Alarm_Vibr8_mean1 = round(sum1 / count_1, 2)  # округляю
            # print(sum1)
            # print(count_1)
            # print('среднее значение за 12 час(M1)', exh3_Alarm_Vibr1_mean1)

            # *******************************************************************************************
            exh1_Alarm_Vibr8_mean = 7.09  # уставка, при достижении, которой необходимо узнать дату и время *************
            # *******************************************************************************************

            # print('exh3_Alarm_Vibr1_mean1', exh3_Alarm_Vibr1_mean1)
            # print('exh3_Alarm_Vibr1_mean2', exh3_Alarm_Vibr1_mean2)

            if exh1_Alarm_Vibr8_mean1 > exh1_Alarm_Vibr8_mean2:
                # print('снижение вибрации за рассматриваемый диапазон по вибрации т.2')
                exh1_Alarm_Vibr8_predictor = datetime.datetime.strptime(('9999-02-01 01:01:01').strip(),
                                                                        '%Y-%m-%d %H:%M:%S')
                exh1_Alarm_Vibr8_str_time_to_alarm = '9999-09-09'
                # print('exh3_Alarm_Vibr1_predictor', exh3_Alarm_Vibr1_predictor)

            else:
                exh1_Alarm_Vibr8_predictor = ((exh1_Alarm_Vibr8_mean - exh1_Alarm_Vibr8_mean1) * (x2_1 - x1_1)) / (
                            exh1_Alarm_Vibr8_mean2 - exh1_Alarm_Vibr8_mean1) + x1_1
                # print('exh3_Alarm_Vibr1_predictor', exh3_Alarm_Vibr1_predictor)

                # print('дата и время выхода из строя ротора', (str(predictor))[:19])

                exh1_Alarm_Vibr8_time_to_alarm = exh1_Alarm_Vibr8_predictor - x2_1
                exh1_Alarm_Vibr8_str_time_to_alarm = (str(exh1_Alarm_Vibr8_time_to_alarm))[:16]
        ...
        return exh1_Alarm_Vibr8_predictor, exh1_Alarm_Vibr8_str_time_to_alarm
...
def exh1_Alarm_Temp7():
    ######################## Считываю данные из conn_file_Exh_ для опредения последнего записанного времени

    with open('Exh3/conn_file/conn_file_Exh1_Temp7.txt', 'r', encoding='utf-8') as file:
    ...
    try:
        ...
        ####### определяю последнее записанное значение по максимальной дате ################################
        cur.execute(
            "select TagTime, Nag1_Temp7  from Exh_All where TagTime = (select MAX(TagTime) from Exh_All)")  # записываю в курсор максимальное значение времени из БД
        ...
        # ********************************** делаю выгрузку данных за текущий час для нахождения среднего значения **********
        temp_str2 = 'select TagTime, Nag1_Temp7  from Exh1_All where TagTime <= ' + "'" + temp_x2_1 + "'" + ' and ' + 'TagTime >= ' + "'" + temp_x2_2 + "'"
        # print('temp_str2', temp_str2)
        # print('x2_1', x2_1)
        # print('x2_2', x2_2)
        mean_point_2 = []  # создаю пустой список (первый час) для дальнейшей записи в него последнего времени и значения переменной
        ...
        exh1_Alarm_Temp7_temp_str1 = 'select TagTime, Nag1_Temp7  from Exh1_All where TagTime <= ' + "'" + temp_x1_1 + "'" + ' and ' + 'TagTime >= ' + "'" + temp_x1_2 + "'"
        # print('temp_str1', temp_str1)
        # print('x1_1', x1_1)
        # print('x1_2', x1_2)

        mean_point_1 = []  # создаю пустой список (12 час) для дальнейшей записи в него последнего времени и значения переменной
        cur.execute(exh1_Alarm_Temp7_temp_str1)  # записываю в курсор данные за последний час
        # print('333')
        # print(type(cur))
        for mnp1 in cur:
            mean_point_1.append(mnp1)
        ...
        if len(mean_point_1) > 0:
            ...
            for kl in mean_point_2:
                ...
                sum2 = sum2 + value2
                count_2 += 1
            exh1_Alarm_Temp7_mean2 = round(sum2 / count_2, 2)  # округляю
            # print(sum2)
            # print(count_2)
            # print('среднее значение за 1 час(M2)', mean2)
            ...
            for kb in mean_point_1:
                ...
                sum1 = sum1 + value1
                count_1 += 1
            exh1_Alarm_Temp7_mean1 = round(sum1 / count_1, 2)  # округляю
            # print(sum1)
            # print(count_1)
            # print('среднее значение за 12 час(M1)', exh3_Alarm_Vibr1_mean1)

            # *******************************************************************************************
            exh1_Alarm_Temp7_mean = 75  # уставка, при достижении, которой необходимо узнать дату и время *************
            # *******************************************************************************************

            # print('exh3_Alarm_Vibr1_mean1', exh3_Alarm_Vibr1_mean1)
            # print('exh3_Alarm_Vibr1_mean2', exh3_Alarm_Vibr1_mean2)

            if exh1_Alarm_Temp7_mean1 > exh1_Alarm_Temp7_mean2:
                # print('снижение вибрации за рассматриваемый диапазон по вибрации т.2')
                exh1_Alarm_Temp7_predictor = datetime.datetime.strptime(('9999-02-01 01:01:01').strip(),
                                                                        '%Y-%m-%d %H:%M:%S')
                exh1_Alarm_Temp7_str_time_to_alarm = '9999-09-09'
                # print('exh3_Alarm_Vibr1_predictor', exh3_Alarm_Vibr1_predictor)

            else:
                exh1_Alarm_Temp7_predictor = ((exh1_Alarm_Temp7_mean - exh1_Alarm_Temp7_mean1) * (x2_1 - x1_1)) / (
                        exh1_Alarm_Temp7_mean2 - exh1_Alarm_Temp7_mean1) + x1_1
                # print('exh3_Alarm_Vibr1_predictor', exh3_Alarm_Vibr1_predictor)

                # print('дата и время выхода из строя ротора', (str(predictor))[:19])

                exh1_Alarm_Temp7_time_to_alarm = exh1_Alarm_Temp7_predictor - x2_1
                exh1_Alarm_Temp7_str_time_to_alarm = (str(exh1_Alarm_Temp7_time_to_alarm))[:16]
        ...
        return exh1_Alarm_Temp7_predictor, exh1_Alarm_Temp7_str_time_to_alarm
...
def exh1_Alarm_Temp8():
    ######################## Считываю данные из conn_file_Exh_ для опредения последнего записанного времени

    with open('Exh3/conn_file/conn_file_Exh1_Temp8.txt', 'r', encoding='utf-8') as file:
    ...
    try:
        ...
        ####### определяю последнее записанное значение по максимальной дате ################################
        cur.execute(
            "select TagTime, Nag1_Temp8  from Exh_All where TagTime = (select MAX(TagTime) from Exh_All)")  # записываю в курсор максимальное значение времени из БД
        ...
        # ********************************** делаю выгрузку данных за текущий час для нахождения среднего значения **********
        temp_str2 = 'select TagTime, Nag1_Temp8  from Exh1_All where TagTime <= ' + "'" + temp_x2_1 + "'" + ' and ' + 'TagTime >= ' + "'" + temp_x2_2 + "'"
        # print('temp_str2', temp_str2)
        # print('x2_1', x2_1)
        # print('x2_2', x2_2)
        mean_point_2 = []  # создаю пустой список (первый час) для дальнейшей записи в него последнего времени и значения переменной
        ...
        exh1_Alarm_Temp8_temp_str1 = 'select TagTime, Nag1_Temp8  from Exh1_All where TagTime <= ' + "'" + temp_x1_1 + "'" + ' and ' + 'TagTime >= ' + "'" + temp_x1_2 + "'"
        # print('temp_str1', temp_str1)
        # print('x1_1', x1_1)
        # print('x1_2', x1_2)

        mean_point_1 = []  # создаю пустой список (12 час) для дальнейшей записи в него последнего времени и значения переменной
        cur.execute(exh1_Alarm_Temp8_temp_str1)  # записываю в курсор данные за последний час
        # print('333')
        # print(type(cur))
        for mnp1 in cur:
            mean_point_1.append(mnp1)
        ...
        if len(mean_point_1) > 0:
            ...
            for kl in mean_point_2:
                ...
                sum2 = sum2 + value2
                count_2 += 1
            exh1_Alarm_Temp8_mean2 = round(sum2 / count_2, 2)  # округляю
            # print(sum2)
            # print(count_2)
            # print('среднее значение за 1 час(M2)', mean2)
            ...
            for kb in mean_point_1:
                ...
                sum1 = sum1 + value1
                count_1 += 1
            exh1_Alarm_Temp8_mean1 = round(sum1 / count_1, 2)  # округляю
            # print(sum1)
            # print(count_1)
            # print('среднее значение за 12 час(M1)', exh3_Alarm_Vibr1_mean1)

            # *******************************************************************************************
            exh1_Alarm_Temp8_mean = 75  # уставка, при достижении, которой необходимо узнать дату и время *************
            # *******************************************************************************************

            # print('exh3_Alarm_Vibr1_mean1', exh3_Alarm_Vibr1_mean1)
            # print('exh3_Alarm_Vibr1_mean2', exh3_Alarm_Vibr1_mean2)

            if exh1_Alarm_Temp8_mean1 > exh1_Alarm_Temp8_mean2:
                # print('снижение вибрации за рассматриваемый диапазон по вибрации т.2')
                exh1_Alarm_Temp8_predictor = datetime.datetime.strptime(('9999-02-01 01:01:01').strip(),
                                                                        '%Y-%m-%d %H:%M:%S')
                exh1_Alarm_Temp8_str_time_to_alarm = '9999-09-09'
                # print('exh3_Alarm_Vibr1_predictor', exh3_Alarm_Vibr1_predictor)

            else:
                exh1_Alarm_Temp8_predictor = ((exh1_Alarm_Temp8_mean - exh1_Alarm_Temp8_mean1) * (x2_1 - x1_1)) / (
                        exh1_Alarm_Temp8_mean2 - exh1_Alarm_Temp8_mean1) + x1_1
                # print('exh3_Alarm_Vibr1_predictor', exh3_Alarm_Vibr1_predictor)

                # print('дата и время выхода из строя ротора', (str(predictor))[:19])

                exh1_Alarm_Temp8_time_to_alarm = exh1_Alarm_Temp8_predictor - x2_1
                exh1_Alarm_Temp8_str_time_to_alarm = (str(exh1_Alarm_Temp8_time_to_alarm))[:16]
        ...
        return exh1_Alarm_Temp8_predictor, exh1_Alarm_Temp8_str_time_to_alarm
...
def predict_Exh1():
    ...
    ####################### Считываю данные из conn_file_Exh_ для опредения последнего записанного времени
    try:
        with open('Exh3/conn_file/conn_file_Exh1_Predict.txt', 'r', encoding='utf-8') as file:
        ...
        exh1_Alarm_Vibr7_predictor, exh1_Alarm_Vibr7_str_time_to_alarm = exh1_Alarm_Vibr7()



        if exh1_Alarm_Vibr7_predictor == datetime.datetime.strptime(('9999-02-01 01:01:01').strip(),
                                                                    '%Y-%m-%d %H:%M:%S'):
            print('********Cнижение вибрации за рассматриваемый диапазон по вибрации т.1********')
            print()
        else:
            print()
            print('Время выхода из строя из-за Vibr1', exh1_Alarm_Vibr7_predictor)

        # Определение выхода из строя ротора по вибрации т.2
        #print('##############################################################################################################')
        # записываю текущие значения предиктора и времени в переменные для дальнейшей обработки
        exh1_Alarm_Vibr8_predictor, exh1_Alarm_Vibr8_str_time_to_alarm = exh1_Alarm_Vibr8()


        if exh1_Alarm_Vibr8_predictor == datetime.datetime.strptime(('9999-02-01 01:01:01').strip(),
                                                                    '%Y-%m-%d %H:%M:%S'):
            print('********Cнижение вибрации за рассматриваемый диапазон по вибрации т.2********')
            print()
        else:
            print('Время выхода из строя из-за Vibr2', exh1_Alarm_Vibr8_predictor)
            print()

        # Определение выхода из строя ротора по температуре т.1
        # записываю текущие значения предиктора и времени в переменные для дальнейшей обработки
        exh1_Alarm_Temp7_predictor, exh1_Alarm_Temp7_str_time_to_alarm = exh1_Alarm_Temp7()

        if exh1_Alarm_Temp7_predictor == datetime.datetime.strptime(('9999-02-01 01:01:01').strip(),
                                                                    '%Y-%m-%d %H:%M:%S'):
            print('********Cнижение вибрации за рассматриваемый диапазон по температуре т.1********')
            print()
        else:

            print('Время выхода из строя из-за Temp1', exh1_Alarm_Temp7_predictor)
            print()

        # Определение выхода из строя ротора по температуре т.2
        # записываю текущие значения предиктора и времени в переменные для дальнейшей обработки
        exh1_Alarm_Temp8_predictor, exh1_Alarm_Temp8_str_time_to_alarm = exh1_Alarm_Temp8()

        if exh1_Alarm_Temp8_predictor == datetime.datetime.strptime(('9999-02-01 01:01:01').strip(),
                                                                    '%Y-%m-%d %H:%M:%S'):
            print('********Cнижение вибрации за рассматриваемый диапазон по температуре т.2********')
            print()
        else:

            print('Время выхода из строя из-за Temp2', exh1_Alarm_Temp8_predictor)
            print()

        #print(77777333333333333333)
        time_min_alarm = min(exh1_Alarm_Vibr7_predictor, exh1_Alarm_Vibr8_predictor, exh1_Alarm_Temp8_predictor,
                             exh1_Alarm_Temp8_predictor)
        ...
        if time_min_alarm == exh1_Alarm_Vibr7_predictor:
            time_count_alarm = exh1_Alarm_Vibr7_str_time_to_alarm
        ...
        elif time_min_alarm == exh1_Alarm_Vibr8_predictor:
            #print(3333333333333333333333)
            time_count_alarm = exh1_Alarm_Vibr8_str_time_to_alarm
            #print(4444444444444444444444)
            name_alarm = 'Причина выхода из строя ротора - повышенная вибрация т.2'
            print(name_alarm)
            print('Количество дней и часов до аварии(ремонта)', time_count_alarm)

        elif time_min_alarm == exh1_Alarm_Temp7_predictor:
            time_count_alarm = exh1_Alarm_Temp7_str_time_to_alarm
            name_alarm = 'Причина выхода из строя ротора - повышенная температура т.1'
            print(name_alarm)
            print('Количество дней и часов до аварии(ремонта)', time_count_alarm)

        elif time_min_alarm == exh1_Alarm_Temp8_predictor:
            time_count_alarm = exh1_Alarm_Temp8_str_time_to_alarm
        ...
        if txt_time_ponit_norm < date_time_now_norm:  # делаю именно такое сравнение, чтобы не перегружать БД и записывать только изменения
            ...
            data_alarm = [
                [date_time_now, exh1_Alarm_Vibr7_predictor, exh1_Alarm_Vibr8_predictor, exh1_Alarm_Temp7_predictor,
                 exh1_Alarm_Temp8_predictor, time_min_alarm, name_alarm, time_count_alarm]]
            # print(data_alarm)
    ...
    try:
        ...
        sql = "INSERT INTO Exh1_Alarm (TagTime, Vibr7_Alarm, Vibr8_Alarm, Temp7_Alarm, Temp8_Alarm, Time_Alarm, Name_Alarm, Count_days_to_Alarm) VALUES (?, ?, ?, ?, ?, ?, ?, ?)"
        ...
        ####### определяю последнее записанное значение по максимальной дате ################################
        cur.execute(
            "select TagTime  from Exh1_Alarm where TagTime = (select MAX(TagTime) from Exh1_Alarm)")  # записываю в курсор максимальное значение времени из БД
        # print(1)
        db_list = []  # создаю пустой список для дальнейшей записи в него строки с максимальным времением.
        for line in cur:
            # print(55)
        ...
        if (db_list[0][0] != txt_time_ponit_norm):
            ...
            # считываю connection_file.txt для создания списка lines, который потом редактирую и делаю перезапись
            # файла connection_file.txt
            with open('Exh3/conn_file/conn_file_Exh1_Predict.txt', 'r', encoding='utf-8') as fr:
                # print(88)
                lines = fr.readlines()
            ...
            # записываю в данные в connection_file.txt
            # print(lines)
            with open('Exh3/conn_file/conn_file_Exh1_Predict.txt', 'w', encoding='utf-8') as fl:
                # print(88)
                fl.writelines(lines)
            ...
            ################ запись в csv файл ###############################################
            with open("Exh3/csv_file/csv_Exh1.csv", mode="a", encoding='utf-8') as w_file:
                # print(5656565656565656565656565656565665666565656565656665)

                    file_writer = csv.writer(w_file, delimiter=",", lineterminator="\r")
                    file_writer.writerow(data_alarm)
...
def hendlerDB5(): # функция обработчик пятого потока данных
    ...
    try:
        ...
        with open("Exh3/csv_file/csv_Exh3.csv", mode="a", encoding='utf-8') as w_file:
            ...
            for j in list_Exh:
                ...
                list_j = [[str_1, str_2, str_3, str_4, str_5, str_6, str_7, str_8, str_9,
                           ...
                           str_19, str_20, str_21, str_22, str_23, str_24, str_25, str_26, str_27, str_28, str_29,
                           str_30, str_31,  str_32,  str_33,  str_34]]
        ...
        ########################################## Запись в БД ######################################
            ...
            with open('Exh3/conn_file/csv_conn_file_Exh_All.txt', 'r', encoding='utf-8') as file:
                txt_lines = file.readlines()
            ...
            try:
                ...
                sql = "INSERT INTO Exh_All ( TagTime, Nag1_temp1, Nag1_Vibr1, Nag1_temp2, Nag1_Vibr2, Nag1_temp3, Nag1_temp4, Nag1_temp5, Nag1_temp6, Nag1_temp7, Nag1_Vibr7, Nag1_temp8, Nag1_Vibr8, Nag1_temp9, Nag2_temp7, Nag2_Vibr7, Nag2_temp8, Nag2_Vibr8, Nag3_temp7, Nag3_Vibr7, Nag3_temp8, Nag3_Vibr8, Nag4_temp7, Nag4_Vibr7, Nag4_temp8, Nag4_Vibr8, Nag5_temp7, Nag5_Vibr7, Nag5_temp8, Nag5_Vibr8, Nag6_temp7, Nag6_Vibr7, Nag6_temp8, Nag6_Vibr8) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"
                #print(' sql211111111111111111111111111===========================')
                # print(11)

                cur.executemany(sql, list_Exh)  ############################################################################ДЛЯ ПЕРЕДАЧИ ДАННЫХ РАСКОММЕНТИРОВАТЬ!!!!!!!!!!!!!!!!!!
                print(' записалось в БД ======================================')
                ##########################################################################################
                # print(22)
                conn.commit()  # сохраняем изменения в БД
