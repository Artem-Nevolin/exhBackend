    ...
    def run(self): # в этом потоке будет проиcходить циклическое выполнение рабочей программы
        try:
            while True:
                ...
                time.sleep(0.0001) ################################################################################## время лучше увеличить
        except Exception:  # отлавливаю потерю связи с БЮ и исключения и игнорирую их
            pass
    ...
    def run(self): # в этом потоке будет проиcходить циклическое выполнение рабочей программы
        try:
            while True:
                ...
                print("Время цикла выполнения программы четвертого потока:", (end - start) * 10 ** 3, "ms")
                time.sleep(
                    0.0001)  ################################################################################## время лучше увеличить
        except Exception:  # отлавливаю потерю связи с БЮ и исключения и игнорирую их
            pass
...
#print('новые даннееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееее', list_Exh3_Temp7)
...
def hendlerDB4(): # функция обработчик четвертого потока данных
    ...
    #print('Привет, я четвертый поток')
